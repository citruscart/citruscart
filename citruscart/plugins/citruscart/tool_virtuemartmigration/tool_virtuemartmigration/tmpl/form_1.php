...
<?php echo $vars->token; ?>
    ...
    <p><?php echo JText::_('COM_CITRUSCART_THIS_TOOL_MIGRATES_DATA_FROM_VM_TO_CITRUSCART'); ?></p>
    ...
    <fieldset>
        <legend><?php echo JText::_('COM_CITRUSCART_DATABASE_CONNECTION'); ?></legend>
            <table class="admintable">
                ...
                <tr>
                    <td width="100" align="right" class="key">
                        <?php echo JText::_('COM_CITRUSCART_VIRTUEMART_TABLE_PREFIX'); ?>: *
                    </td>
                    <td>
