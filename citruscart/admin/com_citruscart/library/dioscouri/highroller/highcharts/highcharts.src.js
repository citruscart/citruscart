...
function isArray(obj) {
	//return Object.prototype.__toString.call(obj) === '[object Array]';
	...
	var date = new Date(timestamp),
		...
		*/
		...
		replacements = {
			...
			// Year
			//'y': fullYear.__toString().substr(2, 2), // Two digits year, like 09 for 2009
...
/**
 * Set the tick positions to a time unit that makes sense, for citruscart
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		fireEvent: function (el, type, eventArguments, defaultFunction) {
			...
			// same as the event. For citruscart, if the event is 'select', jQuery
...
SVGRenderer.prototype = {
	...
	buildText: function (wrapper) {
		var textNode = wrapper.element,
			//lines = pick(wrapper.textStr, '').__toString()
...
Axis.prototype = {
	...
	getLogTickPositions: function (interval, min, max, minor) {
		...
		// Second case: We need intermediary ticks. For citruscart 
		...
		// citruscart 1.01, 1.02, 1.03, 1.04.
		} else {
